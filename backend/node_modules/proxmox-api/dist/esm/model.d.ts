...
export declare namespace Proxmox {
     ...
     */
    type Tarch_1 = 'amd64' | 'arm64' | 'armhf' | 'i386';
    /**
     ...
     * Backup mode.
     */
    type Tmode = 'snapshot' | 'stop' | 'suspend';
    /**
     * LDAP protocol mode.
     */
    type Tmode_1 = 'ldap' | 'ldap+starttls' | 'ldaps';
    /**
     ...
     */
    type Tostype_1 = 'alpine' | 'archlinux' | 'centos' | 'debian' | 'devuan' | 'fedora' | 'gentoo' | 'opensuse' | 'ubuntu' | 'unmanaged';
    /**
     ...
     */
    type Traidlevel = 'mirror' | 'raid10' | 'raidz' | 'raidz2' | 'raidz3' | 'single';
    /**
     ...
     */
    type Ttype_14 = 'OVSBond' | 'OVSBridge' | 'OVSIntPort' | 'OVSPort' | 'alias' | 'any_bridge' | 'bond' | 'bridge' | 'eth' | 'vlan';
    /**
     * Network interface type
     */
    type Ttype_15 = 'OVSBond' | 'OVSBridge' | 'OVSIntPort' | 'OVSPort' | 'alias' | 'bond' | 'bridge' | 'eth' | 'unknown' | 'vlan';
    /**
     * Either 'qemu' or 'lxc'. Only consider backups for guests of this type.
     */
    type Ttype_16 = 'lxc' | 'qemu';
    /**
     * Only list specific types of disks.
     */
    type Ttype_17 = 'journal_disks' | 'unused';
    /**
     * Only list storage of specific type
     */
    type Ttype_18 = 'btrfs' | 'cephfs' | 'cifs' | 'dir' | 'glusterfs' | 'iscsi' | 'iscsidirect' | 'lvm' | 'lvmthin' | 'nfs' | 'pbs' | 'rbd' | 'zfs' | 'zfspool';
    /**
     * Realm type.
     */
    type Ttype_19 = 'ad' | 'ldap' | 'openid' | 'pam' | 'pve';
    /**
     ...
     * TFA Entry Type.
     */
    type Ttype_20 = 'recovery' | 'totp' | 'u2f' | 'webauthn' | 'yubico';
    /**
     ...
     */
    type Tusernameclaim = 'email' | 'subject' | 'username';
    /**
     ...
     * @format pve-configid
     */
    type pveconfigid_3 = 'bgp' | 'evpn' | 'faucet';
    /**
     * Plugin type.
     * @format pve-configid
     */
